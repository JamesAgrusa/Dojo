...
int main()
{
    ...
    Texture2D knight_idle = LoadTexture("characters/knight2.png");
    Texture2D knight_run = LoadTexture("characters/knight2.png");

    Texture2D knight = LoadTexture("characters/knight2.png");
    Vector2 knightPos{
